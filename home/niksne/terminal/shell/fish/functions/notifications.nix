{
  ...
  programs.fish.functions = {
    notifications.body = ''
      ...
      set ENABLED "{ \"text\": \"󰂜\", \"tooltip\": \"notifications <span color='${theme.palette.green}'>on</span>\", \"class\": \"on\" }"
      set DISABLED "{ \"text\": \"󰪑\", \"tooltip\": \"notifications <span color='${theme.palette.maroon}'>off</span>\", \"class\": \"off\" }"
